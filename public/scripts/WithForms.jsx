...
class WithForms extends Component {
  ...
  shouldComponentUpdate (nextProps, nextState) {
    if (!this.state.forms && nextState.forms) {
      this.spinner.stop()
    }
    return true
  }
